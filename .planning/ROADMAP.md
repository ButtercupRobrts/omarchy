...
Plans:
- [ ] 01-01: Rewrite scale persistence to target the monitor's own `hl.monitor()` line and preserve configured position in the live `hyprctl eval` apply
...
|-------|----------------|--------|-----------|
| 1. Per-monitor scale persistence in the scaling CLI | 0/1 | Not started | - |
